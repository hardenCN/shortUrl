...
import com.innmore.shorturl.exception.BizInValidException;
...
public class URLController {
    ...
    public URLController(LocalLRUCacheService localLRUCacheService, BizValidator validator) {
    ...
    public Mono<Res<List<Record>>> createShortUrlByLongUrl(@RequestBody Set<String> longUrls) {
        ...
        return localLRUCacheService.createShortUrlByLongUrl(longUrls);
    }
    ...
    public Mono<Res<List<Record>>> getLongUrlByShortUrl(@RequestBody Set<String> shortUrls) {
        ...
        return localLRUCacheService.getLongUrlByShortUrl(shortUrls);
    }
