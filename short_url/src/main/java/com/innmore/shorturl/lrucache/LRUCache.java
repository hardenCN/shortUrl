package com.innmore.shorturl.lrucache;
...
public class LRUCache<K, V> implements Cache<K, V>, Serializable {
    private static final long serialVersionUID = 4102351291503661158L;
    ...
    public LRUCache(int size) {
        this.size = size;
        this.linkedListNodeMap = new ConcurrentHashMap<>(size,LOAD_FATOR,CONCURRENCY_LEVEL);
