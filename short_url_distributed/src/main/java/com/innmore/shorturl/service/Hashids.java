...
public class Hashids {
   ...
   */
  public static final long FIXED_MAX_NUMBER = 9007199254740992L;

  /**
   * 通过取中间值比较找到的具有8位字符的最大ID 319277809663
    */
  @Value("${innmore.id-generated-max-size}")
  private long MAX_NUMBER = 9007199254740992L;
